...
export interface ApiAnimalTypeAnimalType extends Struct.CollectionTypeSchema {
...
export interface ApiAnimalAnimal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    adopted: Schema.Attribute.Boolean & Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::animal-type.animal-type': ApiAnimalTypeAnimalType;
